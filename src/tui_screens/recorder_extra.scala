...
private def setup_generic(title: String, firstline: String, deflt: String, presets: Seq[String]): String =
...
def setup_getPreset(title: String, encoder: String, deflt: String, presets: Seq[String]): String =
  val determinant =
...
def setup_getPixfmt(title: String, deflt: String, fmts: Seq[String]): String =
